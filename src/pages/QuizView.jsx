    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-900">
        <div className="text-center">
          <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-2">Quiz no encontrado</h2>
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 sticky top-0 z-10">
        ...
        <div className="h-1 bg-gray-200 dark:bg-gray-700">
          <motion.div
            className="h-full bg-logevity dark:bg-logevity-accent"
            initial={{ width: 0 }}
      ...
      <div className="max-w-3xl mx-auto px-4 py-8">
        ...
        {currentQuestion === 0 && (
          <motion.div
            ...
            className="mb-6"
          >
            <Card className="bg-logevity-light/50 dark:bg-logevity/20 border-logevity/20 dark:border-logevity-accent/30">
              <div className="flex items-start gap-3">
                <AlertCircle className="w-5 h-5 text-logevity dark:text-logevity-accent mt-0.5" />
                <div>
                  <p className="font-medium text-gray-900 dark:text-gray-100">Quiz: {module.title}</p>
        ...
        <AnimatePresence mode="wait">
          ...
          >
            <Card className="bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-700">
              <div className="mb-6">
                <span className="text-sm text-logevity dark:text-logevity-accent font-medium">
                  Pregunta {currentQuestion + 1}
                </span>
                <h2 className="text-xl font-heading font-semibold text-gray-900 dark:text-gray-100 mt-2">
                  {currentQ.question}
                </h2>
              </div>
                  ...
                  return (
                    <motion.button
                      ...
                      className={`
                        ...
                        ${isSelected
                          ? 'border-logevity dark:border-logevity-accent bg-logevity-light dark:bg-logevity/20'
                    ...
                    >
                      <div className="flex items-center gap-3">
                        <div className={`
                          ...
                          ${isSelected
                            ? 'border-logevity dark:border-logevity-accent bg-logevity dark:bg-logevity-accent text-white'
                            : 'border-gray-300 dark:border-gray-600'
                          }
                        `}>
                          {isSelected && <CheckCircle className="w-4 h-4" />}
                        </div>
                        <span className={`font-body ${isSelected 
                          ? 'text-logevity dark:text-logevity-accent font-medium' 
              ...
              <button
                ...
                className={`
                  ...
                  ${currentQuestion === index
                    ? 'bg-logevity dark:bg-logevity-accent text-white'
                    : selectedAnswers[q.id] !== undefined
                      ? 'bg-logevity-light dark:bg-logevity/20 text-logevity dark:text-logevity-accent'
        ...
        {currentQuestion === questions.length - 1 && !allAnswered && (
          <motion.p
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            className="text-center text-amber-600 dark:text-amber-400 mt-4 text-sm font-body"
          >
