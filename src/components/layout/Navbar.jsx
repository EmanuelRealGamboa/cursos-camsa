        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex flex-1 max-w-md mx-8">
            <div className="relative w-full">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2.5 bg-gray-100 dark:bg-gray-800 rounded-xl border-2 border-transparent focus:border-logevity focus:bg-white dark:focus:bg-gray-800 outline-none transition-all text-gray-900 dark:text-gray-100 placeholder-gray-400 dark:placeholder-gray-500"
              />
            </div>
          </div>
            ...
            {navLinks.map((link) => (
              <Link
                ...
                className={`
                  ...
                  ${isActive(link.path)
                    ? 'bg-logevity-light dark:bg-logevity/20 text-logevity dark:text-logevity font-medium'
          ...
          <div className="flex items-center gap-3">
            ...
            <button 
              ...
              title={isDark ? "Modo oscuro activo - Click para modo claro" : "Modo claro activo - Click para modo oscuro"}
            >
              {isDark ? (
                <Sun className="w-5 h-5 text-logevity" />
              ) : (
            ...
            <button className="relative p-2 rounded-xl hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors">
              ...
              <span className="absolute top-1 right-1 w-2 h-2 bg-logevity-accent rounded-full" />
            </button>
            ...
            <div className="relative">
              ...
              >
                <img
                  src={user?.avatar || `https://ui-avatars.com/api/?name=${user?.name || 'U'}&background=FFD700&color=000`}
                  alt={user?.name}
